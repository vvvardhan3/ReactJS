  ...
  const [listOfRestaurants, setlistOfRestaurants] = useState([
    ...
    },
    {
      info: {
        ...
        availability: {
          nextCloseTime: "2024-08-27 05:45:00",
          opened: true,
        },
        badges: {},
        isOpen: true,
    ...
    },
    {
      info: {
        ...
        name: "KFC",
        cloudinaryImageId:
          "RX_THUMBNAIL/IMAGES/VENDOR/2024/4/17/6267ecd0-c240-4ef8-8050-527a15356426_614178.JPG",
    ...
    },
    {
      ...
      cta: {
        link: "https://www.swiggy.com/restaurants/kwality-walls-ice-cream-and-more-1st-stage-btm-layout-bangalore-374455",
        text: "RESTAURANT_MENU",
        type: "WEBLINK",
      },
      widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo",
    ...
    },
    {
      info: {
        ...
        availability: {
          nextCloseTime: "2024-08-27 09:00:00",
          opened: true,
        },
        badges: {},
        isOpen: true,
    ...
    <div className="body">
      <div className="filter">
        <button
          ...
          onClick={() => {
            const filteredList = listOfRestaurants.filter( (resData) => resData.info.avgRating > 4.5 )
